...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initData(){
        ...
        String password=sp.getString("userword","");
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_register:
                startActivity(new Intent(LoginActivity.this,RegisterActivity.class));//要注册就到RegisterActivity
                break;
        }
    }
    private void submit(){
        String username=et_username.getText().toString().trim();
        if (TextUtils.isEmpty(username)){//如果监测到username框内为空
            Toast.makeText(this,"账号不能为空",Toast.LENGTH_SHORT).show();
            return;
        }
        String password=et_password.getText().toString().trim();
        if (TextUtils.isEmpty(password)){//如果监测到password框内为空
        ...
        if (user!=null){
            ...
            edit.putString("usename",username);
            ...
            edit.commit();
            startActivity(new Intent(this,MainActivity.class));//登录成功后到MainAcitivity
